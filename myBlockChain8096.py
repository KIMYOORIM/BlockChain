...
PORT_NUMBER = 8096
g_txFileName = "txData8096.csv"  # 트랜잭션 저장하는 파일명
g_bcFileName = "blockchain8096.csv" #blockchian은 블록에 대한 정보를 담고있다.  블록 하나마다 트렌젝션이 포함 되어있다.
g_nodelstFileName = "nodelst8096.csv" # 인접 서버( ip) 와 port  노드들. 네트워킹 할 때 주소를 알아야하는데 그 주소 저장하는 파일
